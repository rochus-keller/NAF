...
#if !defined(_LuaQt3_LuaMainWindow2)
#define _LuaQt3_LuaMainWindow2
...
namespace Lua
{
	class LuaMainWindow2 : public QMainWindow // : public LuaWidget
	{
	public:
		LuaMainWindow2( QWidget* p ):QMainWindow(p) {}
