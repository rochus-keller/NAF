...
#if !defined(_LuaQt3_LuaBox2)
#define _LuaQt3_LuaBox2

#include <LuaQt3/LuaFrame2.h>
#include <Q3HBox> 
#include <Q3VBox>
#include <Q3Grid> 
#include <Q3GroupBox>
...
namespace Lua
{
	...
	class LuaLabel2 : public QLabel
	{
	public:
		LuaLabel2( const char* str, QWidget* p ):QLabel( QString::fromLatin1(str), p ) {}
	...
	public:
		...
		LuaPopupMenu2(QWidget* p):QMenu( p )
		{
            ...
            connect( this, SIGNAL( aboutToShow () ), this, SLOT( _aboutToShow () ) );
		}
	protected slots:
		void _activated ( int itemId );
		void _aboutToShow ();
