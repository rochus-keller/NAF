...
static int createWidget(lua_State * L)
{
	QWidget* parent = 0;
	if( lua_gettop(L) > 0 )
		parent = QtObject<QWidget>::check( L, 1 );
	QtObject<LuaMyWidget2>::create( L, new LuaMyWidget2( parent ) ); 
	// QtObject<QWidget>::instance( L, parent ); // TEST
	return 1;
}
...
{
	QWidget* parent = QtObject<QWidget>::check( L, 1 );
	QString str;
	if( lua_gettop(L) > 1 )
		str = luaL_checkstring( L, 2 );
	LuaPushButton2* p = new LuaPushButton2(parent);
	p->setText( str );
	QtObject<QPushButton>::create( L, p );
	return 1;
}
...
static int createRadioButton(lua_State * L)
{
	...
	w->setText( str );
	QtObject<QRadioButton>::create( L, w );
	return 1;
}
...
static int createButtonGroup(lua_State * L)
{
	...
	QtObject<Q3ButtonGroup>::create( L, w );
	return 1;
}
...
static int createLabel(lua_State * L)
{
	...
	QtObject<LuaLabel2>::create( L, new LuaLabel2( str, parent ) );
	return 1;
}
...
static int createMainWindow(lua_State * L)
{
	...
	if( lua_gettop(L) > 0 )
		parent = Lua::QtObject<QWidget>::check( L, 1 );
	LuaMainWindow2* w = new LuaMainWindow2( parent );
	w->setMenuBar( new LuaMenuBar2(w) );
	if( parent == 0 )
		w->setAttribute( Qt::WA_DeleteOnClose );
	Lua::QtObject<LuaMainWindow2>::create( L, w );
	return 1;
}
...
static int createListView(lua_State * L)
{
	...
	if( lua_gettop(L) > 0 )
		parent = Lua::QtObject<QWidget>::check( L, 1 );
	LuaListView2* w = new LuaListView2( parent );
	if( parent == 0 )
		w->setAttribute( Qt::WA_DeleteOnClose );
	Lua::QtObject<LuaListView2>::create( L, w );
	return 1;
