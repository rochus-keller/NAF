...
namespace Lua
{
	class LuaFrame2 : public Q3Frame // public QFrame
	{
	public:
...
//		static int setFrameStyle(lua_State * L);
	...
	class LuaScrollView2 : public Q3ScrollView // public Q3Frame
	{
		Q_OBJECT
	public:
		static const luaL_reg methods[];
	...
	class LuaTextView2 : public LuaScrollView2 // Q3ScrollView
	{
	public:
		static const luaL_reg methods[];
		static void install( lua_State *L );
	...
	class LuaSplitter2 : public QSplitter // public QFrame
	{
	public:
		static const luaL_reg methods[];
		static void install( lua_State *L );
	...
	class LuaWidgetStack2 : public LuaFrame2 // public Q3Frame
	{
	public:
		static const luaL_reg methods[];
		static void install( lua_State *L );
	...
	class LuaMultiLineEdit2 : public Q3MultiLineEdit // public Q3Frame
	{
		Q_OBJECT
	public:
		static const luaL_reg methods[];
	...
	class LuaCodeEditor : public Lua::CodeEditor // QPlainTextEdit
	{
	public:
		static const luaL_reg methods[];
		static void install( lua_State *L );
