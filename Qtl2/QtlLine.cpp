...
{
    QLineF* lhs = QtValue<QLineF>::check( L, 1 );
    QLineF* r = QtValue<QLineF>::check( L, 2 );
	Util::push( L, lhs->angle( *r ) );
	return 1;
}
int Line::dx(lua_State * L) { return QtValue<QLineF>::getDouble( L, &QLineF::dx ); }
int Line::dy(lua_State * L) { return QtValue<QLineF>::getDouble( L, &QLineF::dy ); }
int Line::intersect(lua_State * L) // ( const QLineF &, QPointF * ) const : IntersectType 
{
    QLineF* lhs = QtValue<QLineF>::check( L, 1 );
    QLineF* l = QtValue<QLineF>::check( L, 2 );
    QPointF* p = QtValue<QPointF>::check( L, 3 );
	Util::push( L, lhs->intersect( *l, p ) );
	return 1;
}
int Line::isNull(lua_State * L) { return QtValue<QLineF>::getBool( L, &QLineF::isNull ); }
int Line::length(lua_State * L) { return QtValue<QLineF>::getDouble( L, &QLineF::length ); }
...
int Line::setLength(lua_State * L) { return QtValue<QLineF>::setDouble( L, &QLineF::setLength ); }
...
int Line::x1(lua_State * L) { return QtValue<QLineF>::getDouble( L, &QLineF::x1 ); }
int Line::x2(lua_State * L) { return QtValue<QLineF>::getDouble( L, &QLineF::x2 ); }
int Line::y1(lua_State * L) { return QtValue<QLineF>::getDouble( L, &QLineF::y1 ); }
int Line::y2(lua_State * L) { return QtValue<QLineF>::getDouble( L, &QLineF::y2 ); }
...
int Line::init(lua_State * L)
{
	...
	{
        QPointF* s = QtValue<QPointF>::check( L, 3 );
		*lhs = QLineF( *p, *s );
	}
	return 0;
}
...
void Line::install(lua_State * L){
    QtValue<QLineF>::install( L, "QLine", _Line );
}
