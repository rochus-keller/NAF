...
{
	QTableView* obj = QtObject<QTableView>::check( L, 1);
...
{
	QTableView* obj = QtObject<QTableView>::check( L, 1);
	QtObject<QHeaderView>::create( L, obj->horizontalHeader() );
	return 1;
}
...
{
	QTableView* obj = QtObject<QTableView>::check( L, 1);
	obj->setHorizontalHeader( QtObject<QHeaderView>::check( L, 2 ) );
	return 0;
}
...
{
	QTableView* obj = QtObject<QTableView>::check( L, 1);
	obj->setVerticalHeader( QtObject<QHeaderView>::check( L, 2 ) );
	return 0;
}
int TableView::sortByColumn(lua_State * L) // ( int column, Qt::SortOrder order )
{
	QTableView* obj = QtObject<QTableView>::check( L, 1);
	obj->sortByColumn( Util::toInt( L, 2 ), (Qt::SortOrder)Util::toInt( L, 3 ) ) ;
	return 0;
}
int TableView::verticalHeader(lua_State * L) // const : QHeaderView * 
{
	QTableView* obj = QtObject<QTableView>::check( L, 1);
	QtObject<QHeaderView>::create( L, obj->verticalHeader() );
	return 1;
}
...
void TableView::install(lua_State * L){
	QtObject<QTableView,QAbstractItemView>::install( L, "QTableView", _TableView );
}
