...
namespace Qtl
{
	...
	{
	public:
		TableWidgetItem ( int type = Type ):QTableWidgetItem(type) {}
		TableWidgetItem ( const QString & text, int type = Type ):QTableWidgetItem(text,type) {}
		TableWidgetItem ( const QIcon & icon, const QString & text, int type = Type ):QTableWidgetItem(icon,text,type){}
		TableWidgetItem ( const TableWidgetItem & other ):QTableWidgetItem(other){}
