...
int Image::depth(lua_State * L){ return QtValue<QImage>::getInt( L, &QImage::depth ); }
int Image::height(lua_State * L){ return QtValue<QImage>::getInt( L, &QImage::height ); }
int Image::heightMM(lua_State * L){ return QtValue<QImage>::getInt( L, &QImage::heightMM ); }
...
int Image::allGray(lua_State * L) { return QtValue<QImage>::getBool( L, &QImage::allGray ); }
int Image::bytesPerLine(lua_State * L) { return QtValue<QImage>::getInt( L, &QImage::bytesPerLine ); }
int Image::color(lua_State * L) // ( int ) const : QRgb 
{
    QImage* obj = QtValue<QImage>::check( L, 1 );
...
int Image::dotsPerMeterX(lua_State * L) { return QtValue<QImage>::getInt( L, &QImage::dotsPerMeterX ); }
int Image::dotsPerMeterY(lua_State * L) { return QtValue<QImage>::getInt( L, &QImage::dotsPerMeterY ); }
...
int Image::invertPixels(lua_State * L) { return QtValue<QImage>::setEnum<QImage::InvertMode>( L, &QImage::invertPixels ); }
int Image::isDetached(lua_State * L) { return QtValue<QImage>::getBool( L, &QImage::isDetached ); }
int Image::isGrayscale(lua_State * L) { return QtValue<QImage>::getBool( L, &QImage::isGrayscale ); }
int Image::isNull(lua_State * L){ return QtValue<QImage>::getBool( L, &QImage::isNull ); }
...
int Image::numBytes(lua_State * L){ return QtValue<QImage>::getInt( L, &QImage::numBytes ); }
...
int Image::serialNumber(lua_State * L) { return QtValue<QImage>::getInt( L, &QImage::serialNumber ); }
...
int Image::setDotsPerMeterX(lua_State * L) { return QtValue<QImage>::setInt( L, &QImage::setDotsPerMeterX ); }
int Image::setDotsPerMeterY(lua_State * L) { return QtValue<QImage>::setInt( L, &QImage::setDotsPerMeterY ); }
int Image::setNumColors(lua_State * L) { return QtValue<QImage>::setInt( L, &QImage::setNumColors ); }
...
{
    QImage* obj = QtValue<QImage>::check( L, 1 );
    QImage* i = QtValue<QImage>::check( L, 2 );
