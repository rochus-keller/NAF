...
namespace Qtl
{
	...
	{
	public:		
        TreeWidgetItem ( int type ):QTreeWidgetItem(type) {}
        TreeWidgetItem ( const QStringList & strings, int type ):QTreeWidgetItem(strings,type) {}
        TreeWidgetItem ( QTreeWidget * parent, int type ):QTreeWidgetItem(parent,type){}
        TreeWidgetItem ( QTreeWidget * parent, const QStringList & strings, int type ):QTreeWidgetItem(parent,strings,type){}
        TreeWidgetItem ( QTreeWidget * parent, QTreeWidgetItem * pre, int type ):QTreeWidgetItem(parent,pre,type){}
        TreeWidgetItem ( QTreeWidgetItem * parent, int type ):QTreeWidgetItem(parent,type){}
        TreeWidgetItem ( QTreeWidgetItem * p, const QStringList & s, int t ):QTreeWidgetItem(p,s,t){}
        TreeWidgetItem ( QTreeWidgetItem * p, QTreeWidgetItem * pre, int t ):QTreeWidgetItem(p,pre,t){}
        TreeWidgetItem ( const TreeWidgetItem & other ):QTreeWidgetItem(other){}
        ~TreeWidgetItem();
        ...
        static void create( lua_State *L, QTreeWidgetItem* i );
