...
int Size::isNull(lua_State * L) { return QtValue<QSizeF>::getBool( L, &QSizeF::isNull ); }
int Size::isEmpty(lua_State * L) { return QtValue<QSizeF>::getBool( L, &QSizeF::isEmpty ); }
int Size::isValid(lua_State * L) { return QtValue<QSizeF>::getBool( L, &QSizeF::isValid ); }
int Size::setHeight(lua_State * L) { return QtValue<QSizeF>::setDouble( L, &QSizeF::setHeight ); }
int Size::setWidth(lua_State * L) { return QtValue<QSizeF>::setDouble( L, &QSizeF::setWidth ); }
int Size::height(lua_State * L) { return QtValue<QSizeF>::getDouble( L, &QSizeF::height ); }
int Size::width(lua_State * L) { return QtValue<QSizeF>::getDouble( L, &QSizeF::width ); }
int Size::scale(lua_State * L) // ( qreal width, qreal height, Qt::AspectRatioMode mode )
// ( const QSizeF & size, Qt::AspectRatioMode mode )
{
    QSizeF* lhs = QtValue<QSizeF>::check( L, 1 );
	if( Util::isNum(L, 2) )
	{
    ...
    else if( QSizeF* p = QtValue<QSizeF>::check( L, 2 ) )
	{
...
{
    QSizeF* lhs = QtValue<QSizeF>::check( L, 1 );
    QSizeF* rhs = QtValue<QSizeF>::check( L, 2 );
...
void Size::install(lua_State * L){
    QtValue<QSizeF>::install( L, "QSize", _Size );
    QtValue<QSizeF>::addMetaMethods( L, _SizeMeta );
