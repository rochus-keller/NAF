...
typedef std::map< std::pair<Dimension,AtomType>, PpmRange > Range;
...
{
	Range::const_iterator i = s_range.find( std::make_pair( d, a ) );
	if( i == s_range.end() )
		return false;
	p = (*i).second;
	return true;
