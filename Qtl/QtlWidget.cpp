...
{	
	...
	if (lua_istable(L,2))
	{
		QList<QAction *> res;
		 ...
		 while (lua_next(L, 2) != 0)
		 {
			...
			QAction* r = ObjectHelper<QAction>::check( L, -1);
			res.append(r);
			i++;
			lua_pop(L, 1);
		 }
	...
	else if(QAction* r = ObjectHelper<QAction>::cast( L, 2 ))
	{
		size=Util::top(L)-1;
		QList<QAction *> res;
		...
		{
			QAction* r = ObjectHelper<QAction>::check( L, i );
			res.append(r);
...
// ( const QPoint & p ) const : QWidget
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	if( Util::isNum(L, 2) )
		ObjectPeer::pushPeer( L, obj->childAt( Util::toInt( L, 2 ), Util::toInt( L, 3 ) ), true);
	else if( QPointF* r = ValueInstaller2<QPointF>::cast( L, 2 ) ) 
		ObjectPeer::pushPeer( L, obj->childAt( r->toPoint() ), true);
	return 1;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	ObjectPeer::pushPeer( L, obj->focusProxy(), true);
	return 1;
}
int Widget::focusWidget(lua_State * L) // const : QWidget
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	ObjectPeer::pushPeer( L, obj->focusWidget(), true);
	return 1;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	if(QCursor* p = ValueInstaller2<QCursor>::cast( L, 2 ))
		obj->grabMouse( *p );
	else
		obj->grabMouse();
	return 0;
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	ObjectPeer::pushPeer( L, obj->inputContext(), true);
	return 1;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	ObjectPeer::pushPeer( L, obj->layout(), true);
	return 1;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	ObjectPeer::pushPeer( L, obj->nextInFocusChain(), true);
	return 1;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	//QPaintEngine* res = ValueInstaller2<QPaintEngine>::create( L ); // TODO
	return 1;
}
...
// ( const QRect & r ) // ( const QRegion & rgn )
{
	...
	else if(QRectF* p = ValueInstaller2<QRectF>::cast( L, 2 ))
		obj->repaint( p->toRect() );
	else if(QRegion* p = ValueInstaller2<QRegion>::cast( L, 2 ))
		obj->repaint( p );
	return 0;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	if(QRectF* p = ValueInstaller2<QRectF>::cast( L, 4 ))
...
// ( int w, int h )
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	if( Util::isNum(L, 2) )
		obj->setFixedSize( Util::toInt( L, 2 ), Util::toInt( L, 3 ) );
	else if(QSizeF* p = ValueInstaller2<QSizeF>::cast( L, 2 ))
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	QInputContext* rhs = ObjectHelper<QInputContext>::check( L, 2);
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	QLayout* rhs = ObjectHelper<QLayout>::check( L, 1);
	obj->setLayout( rhs );
	return 0;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	if(QBitmap* p = ValueInstaller2<QBitmap>::cast( L, 2 ))
		obj->setMask( *p );
	else if(QRegion* p = ValueInstaller2<QRegion>::cast( L, 2 ))
		obj->setMask( *p );
	return 0;
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	QStyle* rhs = ObjectHelper<QStyle>::check( L, 2);
	obj->setStyle( rhs );
	return 0;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	obj->setWindowRole( Lua::Util::toStr( L, 2 ) );
	return 0;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	ObjectPeer::pushPeer( L, obj->style(), true);
	return 1;
...
int Widget::update(lua_State * L) // ( int x, int y, int w, int h )
// ( const QRect & r ) // ( const QRegion & rgn )
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	if( Util::isNum(L, 2) ) 
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	ObjectPeer::pushPeer( L, obj->window(), true);
	return 1;
}
...
{
	QWidget* obj = ObjectHelper<QWidget>::check( L, 1);
	lua_pushstring(L, obj->windowRole().toLatin1() );
	return 1; 
}
...
static const luaL_reg _Widget[] = 
{
	...
	{ Util::s_init, Widget::init },
	{ 0, 0 }
};
void Widget::install(lua_State * L){
	ObjectInstaller<QWidget>::install( L, _Widget, ObjectInstaller<QObject>::className());
}
