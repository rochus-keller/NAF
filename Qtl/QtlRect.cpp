...
{  // ( qreal, qreal, qreal, qreal ) 
	QRectF* lhs = ValueInstaller2<QRectF>::check( L, 1 );
...
int Rect::bottom(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::bottom ); }
...
int Rect::height(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::height ); } 
...
int Rect::isEmpty(lua_State * L) { return ValueInstaller2<QRectF>::getBool( L, &QRectF::isEmpty ); }
int Rect::isNull(lua_State * L) { return ValueInstaller2<QRectF>::getBool( L, &QRectF::isNull ); }
int Rect::isValid(lua_State * L) { return ValueInstaller2<QRectF>::getBool( L, &QRectF::isValid ); }
int Rect::left(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::left ); }
int Rect::moveBottom(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::moveBottom ); } 
...
int Rect::moveLeft(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::moveLeft ); } 
int Rect::moveRight(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::moveRight ); }  
...
int Rect::moveTop(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::moveTop ); }  
...
int Rect::right(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::right ); }
int Rect::setBottom(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setBottom ); } 
...
int Rect::setHeight(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setHeight ); }  
int Rect::setLeft(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setLeft ); }  
...
int Rect::setRight(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setRight ); }  
int Rect::setSize(lua_State * L) // ( const QSizeF & ) 
{
	QRectF* lhs = ValueInstaller2<QRectF>::check( L, 1 );
	QSizeF* s = ValueInstaller2<QSizeF>::check( L, 2 );
	lhs->setSize( *s );
	return 0;
}
int Rect::setTop(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setTop ); }  
...
int Rect::setWidth(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setWidth ); }  
int Rect::setX(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setX ); }  
int Rect::setY(lua_State * L) { return ValueInstaller2<QRectF>::setDouble( L, &QRectF::setY ); }  

int Rect::size(lua_State * L) // () const : QSizeF 
{
	QRectF* lhs = ValueInstaller2<QRectF>::check( L, 1 );
	QSizeF* r = ValueInstaller2<QSizeF>::create( L );
	*r = lhs->size();
	return 1;
}
int Rect::top(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::top ); }
...
int Rect::width(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::width ); } 
int Rect::x(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::x ); }
int Rect::y(lua_State * L) { return ValueInstaller2<QRectF>::getDouble( L, &QRectF::y ); }
int Rect::__eq(lua_State * L)
{
	QRectF* lhs = ValueInstaller2<QRectF>::check( L, 1 );
	QRectF* rhs = ValueInstaller2<QRectF>::check( L, 2 );
	Util::push( L, *lhs == *rhs );
	return 1;
}
...
int Rect::init(lua_State * L)
{
	...
	}else if( QPointF* p = ValueInstaller2<QPointF>::check( L, 2 ) )
	{
		QSizeF* s = ValueInstaller2<QSizeF>::check( L, 3 );
		*lhs = QRectF( *p, *s );
	}
	return 0;
}
...
static const luaL_reg _RectMeta[] =
{
	{ "__eq", Rect::__eq },
	{ 0, 0 }
};
void Rect::install(lua_State * L){
	ValueInstaller2<QRectF>::install( L, _Rect, "QRect" );
	ValueInstaller2<QRectF>::addMethodsToMeta( L, _RectMeta );
}
