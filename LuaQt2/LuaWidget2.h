...
#ifndef _LuaQt2_LuaWidget2
#define _LuaQt2_LuaWidget2
...
namespace Lua
{
	...
	public: 
		...
		static bool pushCallback( ObjectPeer*, Event );
		...
		static int showNormal(lua_State *L);
		static int showFullScreen(lua_State *L);
		static int showMinimized(lua_State *L);
		static int showMaximized(lua_State *L);
		...
		static int mapFromParent(lua_State *L);
		static int mapToParent(lua_State *L);
		static int mapFromGlobal(lua_State *L);
		static int mapToGlobal(lua_State *L);
