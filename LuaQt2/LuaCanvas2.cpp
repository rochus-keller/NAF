...
{
	ObjectInstaller<LuaCanvas2>::install( L, methods,
		ObjectInstaller<QMainWindow>::className(), "Canvas" );
}
...
{
	LuaCanvas2* obj = ObjectHelper<LuaCanvas2>::check( L, 1 );
